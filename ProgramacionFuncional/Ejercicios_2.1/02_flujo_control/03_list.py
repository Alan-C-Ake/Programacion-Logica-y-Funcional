...
lista = [1, 2, 3]
nueva_lista = lista + lista # O también: lista * 2
print(nueva_lista)
...
centro = lista_impar[2:3]
print(f"El centro es {centro[0]}")

# Ejercicio 6: Reversa parcial
# Dada una lista, invierte solo la primera mitad de la lista (utilizando slicing y
# concatenación).
# Ejemplo: lista = [1, 2, 3, 4, 5, 6] -> Resultado: [3, 2, 1, 4, 5, 6]lista_seis = [1, 2, 3, 4, 5, 6]
# Invertir [1, 2, 3] -> [3, 2, 1] y concatenar con el resto [4, 5, 6]
lista_seis = [1, 2, 3, 4, 5, 6]
resultado = lista_seis[2::-1] + lista_seis[3:]
print(resultado)